...
$string['templaterenderer_desc'] = 'Renderer family used to generate this document. Use the PDF overlay renderer for legacy fixed-template documents, or the structured HTML/CSS renderer for the new template model.';
$string['templatepathlabel'] = 'Template PDF path';
$string['templatepathlabel_desc'] = 'Absolute server path to the source PDF for this profile. Required for the legacy PDF overlay renderer. Structured HTML/CSS templates can leave this empty.';
