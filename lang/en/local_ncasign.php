...
$string['tsapresentlabel'] = 'TSA timestamp present';
$string['tsagentimelabel'] = 'TSA generation time';
$string['tsaauthoritylabel'] = 'TSA authority';
$string['tsatokensha256label'] = 'TSA token SHA-256';
$string['ocspcountlabel'] = 'Stored OCSP responses';
$string['ocspurlslabel'] = 'OCSP responder URLs';
...
$string['verifycryptodetails'] = 'Cryptographic signer details';
...
$string['verifyiinidentifierlabel'] = 'Signer IIN / subject identifier';
$string['revocationstatuslabel'] = 'Revocation status';
