...
$string['democustomcerttemplate_desc'] = 'Select the customcert template to render for this demo job. This overrides the template stored on the selected profile for preview only.';
