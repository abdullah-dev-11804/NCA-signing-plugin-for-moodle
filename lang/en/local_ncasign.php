...
$string['serversigningheader_desc'] = 'Uses the fixed server-held PKCS#12 files in /etc/sental/ncasign/signers and passwords from /etc/sental/ncasign/secrets.env. This requires the Java sidecar and padesfinalizerbackend = java_sidecar.';
