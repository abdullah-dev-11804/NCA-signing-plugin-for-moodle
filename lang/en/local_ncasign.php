...
$string['templatesigners_desc'] = 'Optional notification details for the three commission roles, one per line in this template order: commission_chair, commission_member_1, commission_member_2. Format: email|display name|position|expected IIN.';
...
$string['templateautosignenabled'] = 'Enable automatic signing for this template';
$string['templateautosignenabled_desc'] = 'When enabled, pending jobs from this template profile are eligible for server automatic signing after the configured manual signing window.';
...
$string['autosignerexpiryremaining'] = 'expires {$a->date}, {$a->days} days remaining';
$string['autosignerexpiryexpired'] = 'expired {$a->date}, {$a->days} days ago';
...
$string['badgereplacedbyupload'] = 'Replaced by upload';
$string['badgesoftdeleted'] = 'Deleted';
$string['deletejob'] = 'Delete job';
$string['deletejobbutton'] = 'Delete job';
$string['deletejobconfirm'] = 'Job #{$a} will be hidden from active job lists, document views, Public Profile, and Analytics. Files and audit evidence are kept internally.';
$string['jobsoftdeleted'] = 'Job #{$a} was deleted.';
$string['jobsoftdeleteddefaultreason'] = 'Soft deleted by administrator.';
$string['jobactionreason'] = 'Reason';
$string['regeneratejob'] = 'Regenerate job';
$string['regeneratejobbutton'] = 'Regenerate and restart signing';
$string['regeneratejobconfirm'] = 'Job #{$a} will keep the same job ID and verification ID, but the PDF will be regenerated and all signers will need to sign again.';
$string['jobregenerated'] = 'Job #{$a} was regenerated and signing was restarted.';
$string['jobregenerationmessage'] = 'Message for regeneration';
$string['jobregenerationmessage_help'] = 'Optional. This message is stored in the job note so signers/admins can understand why the document was regenerated.';
$string['jobinactivecannotregenerate'] = 'This job is inactive and cannot be regenerated.';
$string['jobregeneratemissingprofile'] = 'This job cannot be regenerated because its template profile is missing.';
